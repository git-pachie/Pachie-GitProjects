...
//    }
    ...
    NSString *post = [NSString stringWithFormat:@"http://www.riverwayauto.com:1980/myjson/Service1.svc/RegisterUser/%1@/archie/%2@/%3@",_txtEmailAddress.text,_txtPhoneNumber.text,DeviceGUID];
...
-(id)jsonPostRequest:(NSData *)jsonRequestData
{
    ...
    [request setValue:[NSString stringWithFormat:@"%d",[jsonRequestData length]] forHTTPHeaderField:@"Content-Lenght"];
